...
| [**Глава 4**](#глава-4-modbus-та-секретний-код-0x41-user-defined-function) | Modbus та функція 0x41 |
...
| [**Глава 10**](#глава-10-що-далі-ai-аналітика) | Що далі: Автоматизований аналіз та регламент робіт |
| [Додатки](#додатки) | Словник термінів · Коди помилок · Підключення до Modbus |

---

> 📋 **Версія 1.1** · Виправлення згідно з: *Huawei SUN2000MA Modbus Interface Definitions Issue 08 (2024-11-07)*, open-source `wlcrs/huawei_solar` (Home Assistant), TapHome Inverter Integration Reference.
