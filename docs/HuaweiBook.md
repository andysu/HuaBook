...
| [**Глава 2**](#глава-2-цифрова-нервова-система-як-і-навіщо-інвертор-пише-логи) | Цифрова нервова система: Як і навіщо інвертор пише логи |
| [**Глава 3**](#глава-3-повна-енциклопедія-логів-deep-dive) | Повна енциклопедія логів (Deep Dive) |
| [**Глава 4**](#глава-4-modbus-та-секретний-код-0x41-user-defined-function) | Modbus та секретний код 0x41 |
...
| [**Глава 7**](#глава-7-майбутнє-діагностики-ai-та-big-data) | Майбутнє діагностики: AI та Big Data |
| [**Глава 8**](#глава-8-huawei-в-сонячній-енергетиці-від-телекому-до-світового-лідерства) | Huawei в сонячній енергетиці: від телекому до світового лідерства *(нова)* |
| [**Глава 9**](#глава-9-mppt-та-iv-curve-diagnostics-фізика-алгоритми-діагностика-панелей) | MPPT та IV Curve Diagnostics: фізика, алгоритми, діагностика *(нова)* |
| [Додатки](#додатки) | Словник термінів · Коди помилок · Підключення до Modbus |

---

> 📋 **Версія 1.1** · Виправлення згідно з: *Huawei SUN2000MA Modbus Interface Definitions Issue 08 (2024-11-07)*, open-source `wlcrs/huawei_solar` (Home Assistant), TapHome Inverter Integration Reference. Виправлено адреси ESS-регістрів (SOC, напруга шини), таблицю AC-сторони (32066, 32072), уточнено EMAP та ARM-опис. Додано: Топ-10 регістрів, декодер стану 32089, Додаток B, коди помилок 313.
...
| 32072 | Струм фази A | I16 | 10 |
| 32074 | Струм фази B | I16 | 10 |
| 32076 | Струм фази C | I16 | 10 |
| 32078 | Реактивна потужність | I32 | 1 |
| 32080 | Активна потужність | I32 | 1 |
| 32082 | Коефіцієнт потужності | I16 | 1000 |
...
| --- | --- | --- | --- | --- |
| **37000** | Стан роботи ESS unit 1 | U16 | 1 | 0=offline, 1=standby, 2=running, 3=fault, 4=sleep |
...
| **SOH** | Стан здоров'я батареї | U16 | 10 | Адреса залежить від серії — звіряйте з Modbus Interface Definitions вашої моделі |
...
| --- | --- | --- | --- | --- |
| 32064 | Вхідна потужність DC | I32 | 1 | Загальна потужність від панелей (Вт) |
| 32069 | Напруга фази A (L1-N) | U16 | 10 | |
| 32070 | Напруга фази B (L2-N) | U16 | 10 | |
| 32071 | Напруга фази C (L3-N) | U16 | 10 | |
| 32080 | Активна потужність AC | I32 | 1 | >0 = генерація, <0 = споживання |
| 32085 | Частота мережі | U16 | 100 | |
| 32087 | Внутрішня температура | I16 | 10 | °C |
| 32089 | Стан інвертора | U16 | 1 | 512 = On-Grid |
...
| Метод | Фізика | Порт | Slave ID | Параметри | Обмеження |
| --- | --- | --- | --- | --- | --- |
| RS485 RTU (прямий) | RS-485 кабель | — | 1 | 9600/8N1 | Нестабільний при підключеному SDongle |
| Modbus TCP (SDongle, стара FW) | Ethernet/Wi-Fi | **502** | 1 | TCP | — |
| Modbus TCP (SDongle, нова FW) | Ethernet/Wi-Fi | **6607** | 1 | TCP | Потребує активації в FusionSolar App |
| Modbus TCP (Wi-Fi AP інвертора) | Wi-Fi 192.168.200.1 | **6607** | 1 | TCP | Одночасно лише 1 підключення |
| SmartLogger (через мережу) | Ethernet | 502 | per inverter | TCP | Потрібен SmartLogger |
